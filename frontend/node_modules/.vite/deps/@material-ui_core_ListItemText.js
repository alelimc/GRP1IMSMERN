import {
  ListContext_default
} from "./chunk-B25CAXZK.js";
import {
  Typography_default
} from "./chunk-NV7EOHCK.js";
import "./chunk-XHI3TQT7.js";
import {
  init_withStyles,
  withStyles_default
...
var ListItemText = React.forwardRef(function ListItemText2(props, ref) {
  ...
  var _React$useContext = React.useContext(ListContext_default), dense = _React$useContext.dense;
  var primary = primaryProp != null ? primaryProp : children;
  if (primary != null && primary.type !== Typography_default && !disableTypography) {
    primary = React.createElement(Typography_default, _extends({
  ...
  if (secondary != null && secondary.type !== Typography_default && !disableTypography) {
    secondary = React.createElement(Typography_default, _extends({
      variant: "body2",
...
var ListItemText_default = withStyles_default(styles, {
  name: "MuiListItemText"
})(ListItemText);
export {
  ListItemText_default as default
};
//# sourceMappingURL=@material-ui_core_ListItemText.js.map
