...
function Unstable_TrapFocus(props) {
  ...
  var ignoreNextEnforceFocus = React2.useRef();
  var sentinelStart = React2.useRef(null);
  var sentinelEnd = React2.useRef(null);
  var nodeToRestore = React2.useRef();
  var rootRef = React2.useRef(null);
  var handleOwnRef = React2.useCallback(function(instance) {
    rootRef.current = ReactDOM2.findDOMNode(instance);
  }, []);
  var handleRef = useForkRef(children.ref, handleOwnRef);
  var prevOpenRef = React2.useRef();
...
var SimpleBackdrop = React3.forwardRef(function SimpleBackdrop2(props, ref) {
  ...
  return open ? React3.createElement("div", _extends({
    "aria-hidden": true,
    ref
  }, other, {
...
var Modal = React4.forwardRef(function Modal2(inProps, ref) {
  ...
  var _React$useState = React4.useState(true), exited = _React$useState[0], setExited = _React$useState[1];
  var modal = React4.useRef({});
  var mountNodeRef = React4.useRef(null);
  var modalRef = React4.useRef(null);
  ...
  var isTopModal = React4.useCallback(function() {
  ...
  var handleClose = React4.useCallback(function() {
  ...
  return React4.createElement(Portal_default, {
    ref: handlePortalRef,
    container,
    disablePortal
  }, React4.createElement("div", _extends({
    ref: handleRef,
    onKeyDown: handleKeyDown,
    role: "presentation"
  }, other, {
    style: _extends({}, inlineStyle.root, !open && exited ? inlineStyle.hidden : {}, other.style)
  }), hideBackdrop ? null : React4.createElement(BackdropComponent, _extends({
    open,
    onClick: handleBackdropClick
  }, BackdropProps)), React4.createElement(Unstable_TrapFocus_default, {
    disableEnforceFocus,
    disableAutoFocus,
    disableRestoreFocus,
    getDoc,
    ...
    open
  }, React4.cloneElement(children, childProps))));
});
true ? Modal.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types4.default.oneOfType([HTMLElementType, import_prop_types4.default.instanceOf(React4.Component), import_prop_types4.default.func]),
  /**
...
//# sourceMappingURL=chunk-O7QQAPOI.js.map
