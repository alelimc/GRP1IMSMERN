...
var Backdrop = React2.forwardRef(function Backdrop2(props, ref) {
...
var Backdrop_default = withStyles_default(styles2, {
  name: "MuiBackdrop"
})(Backdrop);
...
var Dialog = React3.forwardRef(function Dialog2(props, ref) {
  ...
  var mouseDownTarget = React3.useRef();
  ...
  return React3.createElement(Modal_default, _extends({
  ...
  }, React3.createElement(PaperComponent, _extends({
    elevation: 24,
    role: "dialog",
...
true ? Dialog.propTypes = {
   ...
   */
  disableBackdropClick: deprecatedPropType(import_prop_types3.default.bool, "Use the onClose prop with the `reason` argument to filter the `backdropClick` events."),
  /**
   ...
   */
  maxWidth: import_prop_types3.default.oneOf(["lg", "md", "sm", "xl", "xs", false]),
  /**
   * Callback fired when the backdrop is clicked.
   * @deprecated Use the onClose prop with the `reason` argument to handle the `backdropClick` events.
   */
  onBackdropClick: deprecatedPropType(import_prop_types3.default.func, "Use the onClose prop with the `reason` argument to handle the `backdropClick` events."),
  /**
   ...
   */
  onEscapeKeyDown: deprecatedPropType(import_prop_types3.default.func, "Use the onClose prop with the `reason` argument to handle the `escapeKeyDown` events."),
  /**
...
var Dialog_default = withStyles_default(styles3, {
  name: "MuiDialog"
})(Dialog);
export {
  Dialog_default as default
};
//# sourceMappingURL=@material-ui_core_Dialog.js.map
